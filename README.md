...
| `sins-cardvideo.skill` | `/sins-cardvideo` | JSON·미디어 기반 1080×1920 영상 제작, 중앙 1080×1350은 배경 없이 텍스트·이미지·영상만 렌더링 |
...
**⑩ sins-cardvideo** — JSON·미디어 기반 1080×1920 영상 제작, 중앙 1080×1350은 배경 없이 텍스트·이미지·영상만 렌더링
